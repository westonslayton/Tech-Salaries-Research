...
salary_jobs2$job_type<-as.factor(salary_jobs2$job_title)

logistic_reg() |>
  set_engine("glm") |>
  fit(job_type ~ salary_in_usd, data = salary_jobs2, family = "binomial") |>
  tidy() #this is trying to find the probability you're an analyst or an engineer based on your salary

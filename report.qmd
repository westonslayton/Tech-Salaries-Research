...
We can also use logistic regression to show
...
This plot shows that as salary increases, the probability that you're an engineer instead of an analyst increases.
